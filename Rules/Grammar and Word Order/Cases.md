...
The accusative case marks the noun as being part of the object of a clause. Unlike with languages like Latin or German there is no complementary dative case. This means both the direct and indirect object are marked with the accusative case.

The genitive case marks the noun as being a quality of another and is put on nouns after prepositions. For example the English phrase "the capital of the republic" would be translated as "al-Kapitaliun ar-Republikin". The capital is the subject in this example and has the quality of being of the republic. There isn't actually a word for "of" in this case because its use is replaced by the genitive.
